...
@Component({
  ...
  template: `
    <div class="hero">
      <h1>Small Angular Snippets</h1>
      <p>Explore, learn, and share small but powerful Angular snippets.</p>
    </div>
    <div class="container">
      <section id="about">
        <h2>About Small Angular Snippets</h2>
        <p>
          Small Angular Snippets is a personal project dedicated to
          experimenting with Google's Web development framework, Angular, and
          showcasing various code snippets. The goal is to provide simple,
          reusable components that demonstrate the power and flexibility of
          Angular, all without relying on any UI frameworks.
        </p>
        <div class="tech-container">
          ...
          <a
            ...
            rel="noopener"
          >
            <span>Explore Angular Docs</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="14"
      ...
      <section id="featured">
        <h2>Featured Angular Code Snippets</h2>
        <div class="snippets">
